...
insert into person(name, personal_info, date_of_birth, grade)
values ('Nika', 'Это персональная информация', '2004-01-01', 11), 
	   ('Anya', 'Здесь указана информация о человеке', '2010-02-02', 5),
	   ('Katya', 'Тут много разной информации', '2006-12-07', 10);
